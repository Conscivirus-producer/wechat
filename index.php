				...
				if($msgType == "event"){
					...
					if(!empty( $keyword ))
                	{
                		if($keyword == "1"){
	                		...
	                		$resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $contentStr);
	                		echo $resultStr;
						} else if((strpos($keyword,'投') !== false) || (strpos($keyword,'票') !== false) || (strpos($keyword,'号') !== false) || (strpos($keyword,'No') !== false) || (strpos($keyword,'2') !== false) || (strpos($keyword,'3') !== false) || (strpos($keyword,'4') !== false) || (strpos($keyword,'5') !== false) || (strpos($keyword,'6') !== false) || (strpos($keyword,'7') !== false) || (strpos($keyword,'8') !== false) || (strpos($keyword,'9') !== false) || (strpos($keyword,'10') !== false) || (strpos($keyword,'11') !== false)){
							$msgType = "text";
                			//$contentStr = "欢迎关注我教你学，在这里我们可以帮您找到任何你想学的优质辅导和兴趣课程。您可以通过点击下方“免费试听”按钮来找到最合适您的老师。如果您有一技之长想要教你所学，可以回复1并填写申请表格进行注册。如有任何疑问，可以给我们留言，我们会尽快与您联系。";
