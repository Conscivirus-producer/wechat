...
if (isset($_GET['code'])){
    ...
    if($result->num_rows != 0){
    	header("location:https://open.weixin.qq.com/connect/oauth2/authorize?appid=".$appid."&redirect_uri=http://".$rootUrl."/showTeacherInformation.php&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
    	exit;
    }
}else{
