...
class TeacherController extends Controller{
	public function read(){
    	...
    	$Teacher  =   D('Teacher');
    	$data =   $Teacher->join(' T_offers ON T_teacher.openId = T_offers.teacherOpenId')->where($map)->field("T_teacher.name,studentNumber,faculty,major,gender,mobile,created_dt,description,price,highestGrade,address")->select();
